    ...
    <header className="xl:w-[60%] md:w-[80%] w-[85%] mx-auto mt-5">
      <nav className="grid-cols-3 h-16 items-center justify-between mx-auto hidden xl:grid">
        ...
        <ul className="flex gap-6 justify-center *:font-Geist *:tracking-tighter *:font-semibold">
          <li><a className='navigation-bar-links' href="#inicio">Inicio</a></li>
          <li><a className='navigation-bar-links' href="#servicios">Servicios</a></li>
          <li><a className='navigation-bar-links' href="#nosotros">Nosotros</a></li>
          <li><a className='navigation-bar-links' href="#contacto">Contacto</a></li>
        </ul>

        <div className='flex justify-end'>
          <div className='flex border border-[#101d21] rounded-md px-2 py-1 items-center justify-center mr-2 group hover:border-mainColorSubTitle hover:bg-mainColorSubTitle transition duration-100'>
          ...
          <div className='flex bg-mainColorSubTitle rounded-md px-2 py-1 items-center justify-center group hover:bg-[#f2f6f8] border border-mainColorSubTitle transition duration-100 hover:border-[#101d21]'>
