...
const servicesCard = [
  ...
  { backgroundIcon: <Bubbles className='absolute text-[#a6e1ca]/25 w-50 h-50 top-0 right-0' />, icon: <Bubbles />, title: 'Estetica', description: 'Para ponerlos guapos y elegantes' },
