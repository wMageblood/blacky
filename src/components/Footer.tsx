      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#inicio" className="hover:text-[#FADCDB] transition-colors">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#servicios" className="hover:text-[#FADCDB] transition-colors">
                  Servicios
                </a>
              </li>
              <li>
                <a href="#nosotros" className="hover:text-[#FADCDB] transition-colors">
                  Nosotros
                </a>
              </li>
              <li>
                <a href="#contacto" className="hover:text-[#FADCDB] transition-colors">
                  Contacto
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="https://wa.me/+523338086856" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-[#FADCDB] transition-colors">
                  <LucidePhoneIncoming />
                  WhatsApp
                </a>
              </li>
        ...
        <div className="border-t border-white/20 mt-10 pt-6 text-center text-sm text-white/80">
          ...
          <p className="text-sm text-white/70 mt-5">
            ...
            <a href="https://github.com/wMageblood" target="_blank" rel="noopener noreferrer" className="font-medium hover:text-white transition-colors">
            wMageblood
            </a>
          </p>
        </div>
