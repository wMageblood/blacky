...
const SERVICES_DETAILED = [
  ...
  },
  {
    ...
    serviceIcon: <Bubbles className='w-4 h-4 text-[#004444] group-hover:text-white' />,
  ...
  },
  {
    ...
    serviceIcon: <Bone className='w-4 h-4 text-[#004444] group-hover:text-white' />,
  ...
  },
  {
    ...
    serviceIcon: <Home className='w-4 h-4 text-[#004444] group-hover:text-white' />,
  ...
  },
  {
    ...
    serviceIcon: <Syringe className='w-4 h-4 text-[#004444] group-hover:text-white' />,
