...
import { supportDog, esteticaDog, limpiezasDog, guarderiaDog, vacunacionDog, cirugiaDog } from "../assets/images"
...
const SERVICES_DETAILED = [
  {
    ...
    serviceIcon: <Stethoscope className='w-4 h-4 text-servicesButtonBorder group-hover:text-white' />,
    serviceImage: supportDog
  },
  {
    ...
    serviceIcon: <Bubbles className='w-4 h-4 text-servicesButtonBorder group-hover:text-white' />,
    serviceImage: esteticaDog
  },
  {
    ...
    serviceIcon: <Bone className='w-4 h-4 text-servicesButtonBorder group-hover:text-white' />,
    serviceImage: limpiezasDog
  },
  {
    ...
    serviceIcon: <Home className='w-4 h-4 text-servicesButtonBorder group-hover:text-white' />,
    serviceImage: guarderiaDog
  },
  {
    ...
    serviceIcon: <Syringe className='w-4 h-4 text-servicesButtonBorder group-hover:text-white' />,
    serviceImage: vacunacionDog
  },
  {
    ...
    serviceIcon: <Hospital className='w-4 h-4 text-servicesButtonBorder group-hover:text-white' />,
    serviceImage: cirugiaDog
  }
];
