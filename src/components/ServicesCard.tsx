import SERVICES_CARD from "../constants/servicesCard.tsx";

export const ServicesCard = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-3'>
      {SERVICES_CARD.map(({backgroundIcon, icon, title, description}) =>
        <div className='bg-white border border-[#d7e0e1] relative overflow-hidden group hover:bg-[#114040] hover:text-white hover:shadow-blur transition duration-300 rounded-xl mx-3 my-3 md:my-0 p-6'>
