...
export const Services = () => {
  return (
    <div id="servicios" className='my-15'>
      <div className='mx-auto w-[85%] md:w-[80%] xl:w-[60%]'>
        <ServicesDetailed />
      </div>
        <div className='my-10'>
          <p className='text-center tracking-widest font-bold text-[#019099] text-shadow-md text-sm'> COMPARACIÓN </p>
          <h1 className='text-center text-[#101d21] text-3xl font-bold tracking-tight font-Montserrat'>Antes y después.</h1>
        </div>
      <div className='flex justify-center h-auto px-6 w-[85%] md:w-[80%] xl:w-[60%] mx-auto'>
